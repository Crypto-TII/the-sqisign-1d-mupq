...
void xisog_2(ec_point_t* B, ec_point_t const P, ec_point_t K[3])
{
        fp2_sqr(&B->x, &P.x);
        fp2_sqr(&B->z, &P.z);
        fp2_sub(&B->x, &B->z, &B->x);
...
// Outputs the curve coefficient in the form A24=(A+2C:4C)
void xisog_4(ec_point_t* B, ec_point_t const P, ec_point_t K[3])
{
	fp2_sqr(&K[0].x, &P.x);
	fp2_sqr(&K[0].z, &P.z);
...
void xisog_3(ec_point_t* B, ec_point_t K[3])
{
...
void xisog_t(ec_point_t* B, int i, ec_point_t const A, ec_point_t *K)
{
	int j;
...
void xisog_s(ec_point_t* B, int i, ec_point_t const A, ec_point_t *K)
{
	// =================================================================================
