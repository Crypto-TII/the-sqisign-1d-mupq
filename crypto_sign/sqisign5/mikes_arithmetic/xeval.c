...
void xeval_2(ec_point_t* R, ec_point_t* const Q, const int lenQ, ec_point_t K[3])
{
	fp2_t t0, t1, t2;
...
void xeval_4(ec_point_t* R, const ec_point_t* Q, const int lenQ, ec_point_t K[3])
{
	fp2_t t0, t1;
...
void xeval_3(ec_point_t* R, const ec_point_t Q, ec_point_t K[3])
{
	fp2_t t0, t1, t2;
	fp2_add(&t0, &Q.x, &Q.z);
	fp2_sub(&t1, &Q.x, &Q.z);
...
void xeval_t(ec_point_t* Q, int i, ec_point_t const P, ec_point_t *K)
{
	int j;
...
void xeval_s(ec_point_t* Q, int i, ec_point_t const P, ec_point_t const A, ec_point_t *K)
{
	// =================================================================================
